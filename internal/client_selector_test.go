...
var _ = Describe("Redirect behaviour tests", func() {
	var (
		ctx                  context.Context
		selector             *ClientSelector
	...
	BeforeEach(func() {
		...
		// we're going to simulate a redirect to a different domain by responding with a localhost url rather than a 127.0.0.1 url
	...
	It("Doesn't resuse client for redirect", func() {
